...
class Contact extends Component {
  ...
  render() {
    return (<div style={{
      ...
      <button className="contact__box" onClick={() => this.showContact()}>
      ...
      <div className="contact__big hidden" onMouseLeave={() => this.hideContact()} onClick={() => this.hideContact()}>
        ...
        <p className="contact__text--main">I'm a gender queer jane of all trades<br/>
          I like to fix things and make things pretty<br/>I am the queen of improvisation<br/>I speak
          <span className="contact__text--link"> German </span>
          and
          <span className="contact__text--link"> English </span>
          fluently<br/>Currently you can find me in
          <span className="contact__text--link"> Berlin</span><br/>
          You can download my CV
          <a href="/cv.pdf" className="contact__text--link font"> here</a>
        </p>
      </div>
    </div>)
  }
