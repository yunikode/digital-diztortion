    ...
    return (
      ...
      >
        <button
          ...
          onMouseOver={this.showContact}
        >
          <span className="contact__text">about me</span>
        </button>
        <div
          className="contact__big hidden"
          onMouseLeave={() => this.hideContact()}
          onClick={() => this.hideContact()}
        >
          <h1 className="contact__header">Hi, I'm zee-german</h1>
          <p className="contact__text--main">
            I'm a gender queer jane of all trades
            <br />
            I like to fix things and make things pretty
            <br />I am the queen of improvisation
            <br />I speak
            <span className="contact__text--link"> German </span>
            and
            <span className="contact__text--link"> English </span>
            fluently
            <br />
            Currently you can find me in
            <span className="contact__text--link"> Cologne</span>
            <br />
            You can download my CV
            <a href="/cv.pdf" className="contact__text--link font">
              {' '}
              here
            </a>
          </p>
