...
const ToolsData = [
  {
    ...
    pics: [
      ...
      'https://c1.staticflickr.com/8/7809/47052095402_da63046f0f_b.jpg',
      'https://c1.staticflickr.com/8/7837/46190567315_e35f0a91f1_b.jpg',
      'https://c1.staticflickr.com/8/7853/46190567305_0838411db6_b.jpg'
    ],
    blurb:
      'A todos manager on the commandline for powerusers to keep up to date without exiting the terminal.\n## Features\n\n- Overview of all tasks\n- Sort by different parameters'
  },
  {
    title: 'Weather',
    ...
    pics: [
      'https://images.unsplash.com/photo-1519110437047-c6488cf2051d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=967&q=80',
      'https://c1.staticflickr.com/8/7858/46190567665_21a3a369ca_b.jpg'
    ],
    tech: ['Node JS ', 'Openweather API'],
    blurb:
      'Check the current weather just from your terminal, see the forecast for the day.\n## Features\n- different cities with one parameter away\n- change between metric and imperial'
  }
];
